...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeEMRO = new QSpinBox(tabMain);
        anonymizeEMRO->setObjectName(QStringLiteral("anonymizeEMRO"));
        anonymizeEMRO->setMinimum(2);
        anonymizeEMRO->setMaximum(10000);
        anonymizeEMRO->setSingleStep(10);
        anonymizeEMRO->setValue(1000);

        gridLayout->addWidget(anonymizeEMRO, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Emro after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Emro on system login", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Emro to keep anonymized", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Emro client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Emro network through a SOCKS5 proxy (e.g. when connecting through Tor).", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Emro.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
