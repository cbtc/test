...
public:
    ...
    void retranslateUi(QDialog *AdrenalineNodeConfigDialog)
    {
        ...
        detailText->setToolTip(QApplication::translate("AdrenalineNodeConfigDialog", "<html><head/><body><p>This pane shows an example Emro.conf template with the necessary masternode settings.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
