...
public:
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "Emro Node Count:", Q_NULLPTR));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "Emro Network", Q_NULLPTR));
