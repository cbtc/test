...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 EMRO"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 EMRO"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 EMRO"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 EMRO"));
