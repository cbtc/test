...
public:
    ...
    void retranslateUi(QDialog *DarksendConfig)
    {
        ...
        label_2->setText(QApplication::translate("DarksendConfig", "Use 2 separate masternodes to mix funds up to 1000 EMRO", Q_NULLPTR));
        label_3->setText(QApplication::translate("DarksendConfig", "Use 8 separate masternodes to mix funds up to 1000 EMRO", Q_NULLPTR));
        label_4->setText(QApplication::translate("DarksendConfig", "Use 16 separate masternodes", Q_NULLPTR));
        label_6->setText(QApplication::translate("DarksendConfig", "This option is the quickest and will cost about ~0.025 EMRO to anonymize 1000 EMRO", Q_NULLPTR));
        label_7->setText(QApplication::translate("DarksendConfig", "This option is moderately fast and will cost about 0.05 EMRO to anonymize 1000 EMRO", Q_NULLPTR));
        ...
        label_9->setText(QApplication::translate("DarksendConfig", "0.1 EMRO per 1000 EMRO you anonymize.", Q_NULLPTR));
    } // retranslateUi
