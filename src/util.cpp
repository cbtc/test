...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Emro
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Emro
    // Mac: ~/Library/Application Support/Emro
    // Unix: ~/.Emro
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Emro";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Emro.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "EMROd.pid"));
