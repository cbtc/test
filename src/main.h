...
static const int64_t STATIC_POS_REWARD = 3 * COIN; //Constant reward of 3.5 EMRO per COIN
static const int64_t TARGET_SPACING = 240; // 2 min per Block
static const int64_t TARGET_SPACING2 = 240; // 2 min per Block
...
static const int64_t MAX_MONEY = 15000000 * COIN; // 15M coins
